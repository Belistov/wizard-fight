...
function spawnBird() {
    ...
    if (Math.random() > 0.9) {
        ...
        bird.style.top = `${Math.random() * 40 + 5}%`; // Random height between 5% and 45%
        ...
        if (direction === "left") {
            ...
            bird.style.left = "110%"; // Start off-screen right
            bird.dataset.direction = "left";
            bird.style.transform = "scaleX(-1)"; // Flip horizontally
        }
